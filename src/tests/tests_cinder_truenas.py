...
"""Encapsulate cinder-truenas testing."""
...
class CinderTrueNASTest(test_utils.OpenStackBaseTest):
    """Encapsulate TrueNAS tests."""

    @classmethod
    def setUpClass(cls):
        """Run class setup for running tests."""
        super(CinderTrueNASTest, cls).setUpClass()
