...
import charm.openstack.cinder_truenas as cinder_truenas

import charms_openstack.test_utils as test_utils


class TestCinderTrueNASCharm(test_utils.PatchHelper):
    ...
    def _patch_config_and_charm(self, config):
        ...
        c = cinder_truenas.CinderTrueNASCharm()
        return c

    def test_cinder_base(self):
        charm = self._patch_config_and_charm({})
        self.assertEqual(charm.name, 'cinder_truenas')
        self.assertEqual(charm.version_package, 'cinder-truenas-charm')
        self.assertEqual(charm.packages, ['cinder-truenas-charm'])
